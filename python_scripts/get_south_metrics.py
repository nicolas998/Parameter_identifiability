...
perf.update_dic('5', path='/Users/nicolas/Parameter_identifiability/data/hlm_outputs/south/*vr5*', 
                ...
                isDataFrame = True, 
                DataFrameColumn = 'Q')
perf.update_dic('6', path='/Users/nicolas/Parameter_identifiability/data/hlm_outputs/south/*vr6*', 
                path2linkFunc=get_links2, 
                isDataFrame = True, 
                DataFrameColumn = 'Q')
...
M = pd.concat(M)
M.to_msgpack('/Users/nicolas/Parameter_identifiability/data/processed/south_event_met.msg')